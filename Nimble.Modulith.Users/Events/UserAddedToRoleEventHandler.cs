...
public class UserAddedToRoleEventHandler : INotificationHandler<UserAddedToRoleEvent>
{
    ...
    public UserAddedToRoleEventHandler(IMediator mediator, ILogger<UserAddedToRoleEventHandler> logger)
    {
        _mediator = mediator;
        _logger = logger;
    }
    ...
    {
        _logger.LogInformation("User {UserId} added to role {Role}, sending email", notification.UserId, notification.RoleName);
